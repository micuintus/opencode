  ...
  export async function environment(model: Provider.Model) {
    ...
    return [
      ...
      [
        ...
        ``,
        `<oc-examples>`,
        `Ralph Loop — TODO-driven state machine (the core pattern for iterative work):`,
        `  Use oc todo as your state machine. Discover work items, create todos, fix each, verify.`,
        `  The loop keeps going until the exit condition is met. No artificial limits.`,
        ``,
        `  # Phase 1: Discover`,
        `  oc todo add "Discover failures" && oc todo add "Fix each" && oc todo add "Verify clean"`,
        `  output=$(npm test 2>&1); oc todo done 1`,
        ``,
        `  # Phase 2: Create dynamic todos from discovery, then fix each`,
        ...
        `  done; oc todo done 2`,
        ``,
        `  # Phase 3: Verify loop — keep going until clean (Ralph: embrace fallibility)`,
