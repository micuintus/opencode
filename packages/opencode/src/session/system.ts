  ...
  export async function environment(model: Provider.Model) {
    ...
    return [
      ...
      [
        ...
        ``,
        `Parallelism: use up to 3 concurrent oc prompt calls (same limit as subagents).`,
        `For oc tool calls (deterministic, no LLM): no concurrency limit — as many as needed.`,
